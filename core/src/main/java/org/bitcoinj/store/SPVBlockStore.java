        ...
        try {
            ...
            do {
                ...
                if (Arrays.equals(scratch, targetHashBytes)) {
                	...
                	if(hash.equals(Sha256Hash.wrap("00000006941e463cf1cb6c74024228810dc81545c854ba5153b117d3bf602204")))
                	{
                		 storedBlock = new StoredBlock(params.getGenesisBlock(),new BigInteger("0000000000000000000000000000000000000000000000000000000010000100") , 0);
                	}
                	else
