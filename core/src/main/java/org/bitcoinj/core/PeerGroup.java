...
public class PeerGroup implements TransactionBroadcaster {
    ...
    public void setMaxConnections(int maxConnections) {
        ...
        log.info("nowConnections:"+channels.getConnectedClientCount());
    ...
    private Runnable triggerConnectionsJob = new Runnable() {
        ...
        public void go() {
            ...
            lock.lock();
            try {
            	log.info("countConnectedAndPendingPeers:"+countConnectedAndPendingPeers());
            	log.info("mypeers:"+peers.size());
            	log.info("getMaxConnections:"+getMaxConnections());
                if (doDiscovery) {
    ...
    private void triggerConnections() {
    	...
    	log.info("triggerConnections hh");
