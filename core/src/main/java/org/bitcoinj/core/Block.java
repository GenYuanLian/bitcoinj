...
public class Block extends Message {
    ...
    public void setHash(Sha256Hash u) {
    	hash = u;
    }
    /**
    ...
    protected void parse() throws ProtocolException {
        // header
    	if(this.hash == Sha256Hash.wrap("00000006941e463cf1cb6c74024228810dc81545c854ba5153b117d3bf602204"))
    	{
    	 return;
    	}
        cursor = offset;
        ...
        nonce = readUint32();
        // hash = getHash();
        hash = Sha256Hash.wrapReversed(Sha256Hash.hashLyz2(payload, offset, cursor - offset));
        log.info("parse the hash:"+hash.toString());
    ...
    void writeHeader(OutputStream stream) throws IOException {
        ...
        if (headerBytesValid && payload != null && payload.length >= offset + HEADER_SIZE) {
        	log.info("OuputStream,offset:"+offset);
    ...
    private Sha256Hash calculateHash() {
        try {
            ...
            writeHeader(bos); 
            //params
            log.info("blocktime:"+time);
            //log.info("try hash:"+);
            return Sha256Hash.wrapReversed(Sha256Hash.hashLyz2(bos.toByteArray()));
        } catch (IOException e) {
    ...
    public BigInteger getDifficultyTargetAsInteger() throws VerificationException {
    	...
    	if(this.hash.equals(Sha256Hash.wrap("00000006941e463cf1cb6c74024228810dc81545c854ba5153b117d3bf602204")))
    	{
    		return target;
    	}
    ...
    protected boolean checkProofOfWork(boolean throwException) throws VerificationException {
        ...
        BigInteger target = getDifficultyTargetAsInteger();
        //双hash后进行比较 如果满足的话就接受
        //target
        //getHash
        //这还是对block中的一个值进行双hash 所以该值是？解决方案是在临界点进行去掉该判
        //过了临界点后就是lyzarhash的了
...
//        }
    ...
    public Sha256Hash getMerkleRoot() {
    	if(this.hash == Sha256Hash.wrap("00000006941e463cf1cb6c74024228810dc81545c854ba5153b117d3bf602204"))
    	{
    		return Sha256Hash.wrap("7b3e8f0a5371086cf000d11b5e6bd1f8779980af855623b6eb28c4d63d3b12a4");
    	}
        if (merkleRoot == null) {
