...
public abstract class NetworkParameters {
  ...
  //巨额基础预分配 地址
  String BASE_ALLOC_ADDR  = "04bbd2f8ba5aa4e66767ebf47143ab8d85ddc0bad8da9e1b994d5a43a188b20895b13dd5e39c62c6fb8979fee0a59c7e828fde38ee53180924f5d6f4fe5c24d5b1";

  //小额批量预分配 (地址,金额)
  class PreAllo{
  	String ptrScriptPubKey;
  	double amAlloc;
  };
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            //
            //  The Source BlockChain, a leading economic collaboration platform.
           
        	//签名coinbase
        	byte[] bytes = Utils.HEX.decode
                    ("04ffff001d01044154686520536f7572636520426c6f636b436861696e2c2061206c656164696e672065636f6e6f6d696320636f6c6c61626f726174696f6e20706c6174666f726d2e");
        ...
        //genesisBlock所有东西构建 手动构建。。注意！这个只是轻钱包
        genesisBlock.setMerkleRoot(Sha256Hash.wrap("7b3e8f0a5371086cf000d11b5e6bd1f8779980af855623b6eb28c4d63d3b12a4"));
        return genesisBlock;
    }
